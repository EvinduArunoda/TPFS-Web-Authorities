...
class LoginForm extends React.Component {
  ...
  render() {
    ...
    return (
      <Fragment>
        <div id="notification">
          { initialValues.get('error')
          // eslint-disable-next-line no-return-assign
        && <Notification close={() => document.getElementById('notification').style.display = 'none'} message={initialValues.get('error')} />
          }
        </div>
        <Paper className={classNames(classes.paperWrap, deco && classes.petal)} style={{ maxWidth: 800 }}>
          <Typography variant="h4" className={classes.title} gutterBottom>
              Traffic Police Fining System
          </Typography>
