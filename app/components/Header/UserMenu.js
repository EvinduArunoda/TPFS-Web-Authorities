...
class UserMenu extends React.Component {
  ...
  render() {
    const { classes } = this.props; // 'dark' prop was assigened earlier
    ...
    return (
      <div>
        ...
        <Menu
          ...
          onClose={this.Close}
        >
          {/* <MenuItem onClick={this.Close} component={Link} to={link.profile}>My Profile</MenuItem> */}
          {/* <MenuItem onClick={this.Close} component={Link} to={link.calendar}>My Calendar</MenuItem> */}
          <MenuItem onClick={this.OpenNotifications} component={Link} to={link.email}>
              Send Notifications
          </MenuItem>
          <Divider />
